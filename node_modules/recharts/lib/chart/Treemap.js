...
exports.treemapPayloadSearcher = exports.computeNode = exports.addToTreemapNodeIndex = exports.Treemap = void 0;
...
class Treemap extends _react.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_RechartsStoreProvider.RechartsStoreProvider, {
      ...
      reduxStoreName: (_this$props$className = this.props.className) !== null && _this$props$className !== void 0 ? _this$props$className : 'Treemap'
