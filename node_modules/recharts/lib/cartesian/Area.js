...
function StaticArea(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /*#__PURE__*/_react.default.createElement(_Layer.Layer, {
  ...
  })), stroke !== 'none' && /*#__PURE__*/_react.default.createElement(_Curve.Curve, _extends({}, (0, _ReactUtils.filterProps)(props, false), {
    ...
    fill: "none",
    points: points
  })), stroke !== 'none' && isRange && /*#__PURE__*/_react.default.createElement(_Curve.Curve, _extends({}, (0, _ReactUtils.filterProps)(props, false), {
    className: "recharts-area-curve",
    layout: layout,
    type: type,
    connectNulls: connectNulls,
...
function ClipRect(_ref5) {
  ...
  if (layout === 'vertical') {
    return /*#__PURE__*/_react.default.createElement(VerticalRect, {
      alpha: alpha,
      points: points,
      baseLine: baseLine,
  ...
  return /*#__PURE__*/_react.default.createElement(HorizontalRect, {
    alpha: alpha,
    points: points,
    baseLine: baseLine,
    strokeWidth: strokeWidth
...
function AreaWithAnimation(_ref6) {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactSmooth.default, {
    ...
    if (prevPoints) {
      ...
      return /*#__PURE__*/_react.default.createElement(StaticArea, {
        points: stepPoints,
    ...
    }, /*#__PURE__*/_react.default.createElement(ClipRect, {
      alpha: t,
      points: points,
      baseLine: baseLine,
      layout: props.layout,
    ...
    }, /*#__PURE__*/_react.default.createElement(StaticArea, {
      points: points,
      baseLine: baseLine,
      needClip: needClip,
      clipPathId: clipPathId,
...
function RenderArea(_ref8) {
   ...
   * So, useRef it is.
   */
  var previousPointsRef = (0, _react.useRef)();
  ...
  points && points.length && (prevPoints !== points || prevBaseLine !== baseLine)) {
    return /*#__PURE__*/_react.default.createElement(AreaWithAnimation, {
      needClip: needClip,
      clipPathId: clipPathId,
      props: props,
...
class AreaWithState extends _react.PureComponent {
  ...
  render() {
    ...
    }))), /*#__PURE__*/_react.default.createElement(RenderArea, {
      needClip: needClip,
      clipPathId: clipPathId,
      props: this.props
    })), /*#__PURE__*/_react.default.createElement(_ActivePoints.ActivePoints, {
      points: points,
      mainColor: getLegendItemColor(this.props.stroke, this.props.fill),
      itemDataKey: this.props.dataKey,
      activeDot: this.props.activeDot
    }), this.props.isRange && Array.isArray(baseLine) && /*#__PURE__*/_react.default.createElement(_ActivePoints.ActivePoints, {
      points: baseLine,
      mainColor: getLegendItemColor(this.props.stroke, this.props.fill),
      itemDataKey: this.props.dataKey,
      activeDot: this.props.activeDot
...
function AreaImpl(props) {
  ...
  var {
    ...
    isRange,
    baseLine
  } = (_useAppSelector = (0, _hooks.useAppSelector)(state => (0, _areaSelectors.selectArea)(state, props.xAxisId, props.yAxisId, isPanorama, areaSettings))) !== null && _useAppSelector !== void 0 ? _useAppSelector : {};
  var {
    height,
    width,
    left,
  ...
  return /*#__PURE__*/_react.default.createElement(AreaWithState, _extends({}, everythingElse, {
    activeDot: activeDot,
...
class Area extends _react.PureComponent {
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_CartesianGraphicalItemContext.CartesianGraphicalItemContext, {
      ...
      args: this.props
    }), /*#__PURE__*/_react.default.createElement(AreaImpl, this.props));
  }
}
exports.Area = Area;
