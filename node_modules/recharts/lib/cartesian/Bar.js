...
function BarBackground(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, data.map((entry, i) => {
    var {
        value,
...
function BarRectangles(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, data.map((entry, i) => {
    ...
    }), /*#__PURE__*/_react.default.createElement(_BarUtils.BarRectangle, barRectangleProps));
...
function RectanglesWithAnimation(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactSmooth.default, {
    ...
    return /*#__PURE__*/_react.default.createElement(_Layer.Layer, null, /*#__PURE__*/_react.default.createElement(BarRectangles, {
      props: props,
      data: stepData,
...
function RenderRectangles(props) {
  ...
  if (isAnimationActive && data && data.length && (previousRectanglesRef.current == null || previousRectanglesRef.current !== data)) {
    return /*#__PURE__*/_react.default.createElement(RectanglesWithAnimation, {
      previousRectanglesRef: previousRectanglesRef,
      props: props
    });
  }
  return /*#__PURE__*/_react.default.createElement(BarRectangles, {
    props: props,
    data: data,
    showLabels: true
  });
...
class BarWithState extends _react.PureComponent {
  ...
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement(BarBackground, {
      data: data,
      dataKey: dataKey,
      background: background,
      allOtherBarProps: this.props
    }), /*#__PURE__*/_react.default.createElement(RenderRectangles, this.props)), /*#__PURE__*/_react.default.createElement(_ErrorBar.SetErrorBarPreferredDirection, {
...
function BarImpl(props) {
  ...
  var rects = (0, _hooks.useAppSelector)(state => (0, _barSelectors.selectBarRectangles)(state, props.xAxisId, props.yAxisId, isPanorama, barSettings, cells));
  ...
  return /*#__PURE__*/_react.default.createElement(_CartesianGraphicalItemContext.SetErrorBarContext, {
    xAxisId: xAxisId,
    yAxisId: yAxisId,
    data: rects,
    dataPointFormatter: errorBarDataPointFormatter,
    errorBarOffset: errorBarOffset
  }, /*#__PURE__*/_react.default.createElement(BarWithState, _extends({}, props, {
    layout: layout,
    needClip: needClip,
    data: rects,
    xAxisId: xAxisId,
...
class Bar extends _react.PureComponent {
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_CartesianGraphicalItemContext.CartesianGraphicalItemContext, {
    ...
    }, /*#__PURE__*/_react.default.createElement(_ReportBar.ReportBar, null), /*#__PURE__*/_react.default.createElement(_SetLegendPayload.SetLegendPayload, {
      ...
      args: this.props
    }), /*#__PURE__*/_react.default.createElement(BarImpl, this.props));
  }
}
exports.Bar = Bar;
