...
class ScatterWithState extends PureComponent {
  constructor() {
    super(...arguments);
    _defineProperty(this, "id", uniqueId('recharts-scatter-'));
  }
  render() {
    var {
      hide,
    ...
    return /*#__PURE__*/React.createElement(Layer, {
      ...
      errorBarOffset: 0
    }, this.props.children), /*#__PURE__*/React.createElement(Layer, {
      key: "recharts-scatter-symbols"
    }, /*#__PURE__*/React.createElement(RenderSymbols, this.props)));
  }
}
...
function ScatterImpl(props) {
  ...
  }), /*#__PURE__*/React.createElement(ScatterWithState, _extends({}, everythingElse, {
    xAxisId: xAxisId,
    yAxisId: yAxisId,
    zAxisId: zAxisId,
    lineType: lineType,
