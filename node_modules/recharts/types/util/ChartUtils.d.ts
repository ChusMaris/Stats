...
import { AxisTick, AxisType, BaseAxisProps, ChartCoordinate, ChartOffset, DataKey, LayoutType, NumberDomain, PolarViewBox, RangeObj, Size, StackOffsetType, TickItem } from './types';
...
export declare const calculateActiveTickIndex: (coordinate: number, ticks: ReadonlyArray<TickItem>, unsortedTicks: ReadonlyArray<TickItem> | undefined, axisType: AxisType | undefined, range: AxisRange | undefined) => number;
...
export declare const appendOffsetOfLegend: (offset: ChartOffset, legendSettings: LegendSettings, legendSize: Size) => ChartOffset;
